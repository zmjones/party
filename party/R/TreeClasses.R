...
setClass("ContinuousVariable", representation = representation(
...
setClass("OrderedCategoricalVariable", representation = representation(
    scores = "numeric",
    order = "integer"), contains = "CategoricalVariable")
