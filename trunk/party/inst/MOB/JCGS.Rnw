...
\fancyhead[CO]{\textit{\normalsize Achim Zeileis, Torsten Hothorn, Kurt Hornik}}
\fancyhead[CE]{\textit{\normalsize Model-based Recursive Partitioning}}
\fancyfoot[LO,LE]{\small Copyright {\copyright} 2008 American Statistical Association,%
  Institute of Mathematical Statistics, and Interface Foundation of North America}
\fancypagestyle{plain}{
\fancyhf{}
\fancyfoot[LO,LE]{\small This is a preprint of an article accepted for publication in%
  \textit{Journal of Computational and Graphical Statistics}. %
  Copyright {\copyright} 2008 American Statistical Association,%
  Institute of Mathematical Statistics, and Interface Foundation of North America
  \doi{10.1198/10618600SX319331}}
}
...
even for fixed $B$. However, if there is only one partitioning variable ($\ell = 1$),
...
found only with respect to glucose (with a Bonferroni-adjusted $p$~value of
...
UCI machine learning repository \citep{AsuncionNewman2007}. The data set contains
