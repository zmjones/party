...
\begin{figure}[hp!]
\begin{center}
<<glaucoma-plot-inner, echo = TRUE, fig = TRUE, height = 7, width = 10>>=
...
\begin{figure}[ht]
\begin{center}
<<glaucoma-classprob, echo = TRUE, fig = TRUE, height = 5, width = 5>>=
...
legend(0.18, 0.5, pch = 1:2, legend = levels(GlaucomaM$Class), bty = "n")
@
